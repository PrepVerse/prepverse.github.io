...
import { LandingStatsLinkedInIcon } from "./icons/landing-stats-linkedin";
                ...
                >
                    ...
                    >
                        <div className={clsx("hidden landing-md:block")}>
                            <NumberField number={90} label="Contributors" />
                        </div>
                        <div className={clsx("block", "landing-md:hidden")}>
                            <NumberField
                                number={githubStarCount ?? 9500}
                                label="GitHub Stars"
                            />
                        </div>
                        <div
...
const LinkedInStats = () => {
    const { linkedinMemberCount } = useCommunityStatsContext();
    return (
        <div
            className={clsx(
                "rounded-xl",
        ...
        >
            ...
            >
                ...
                <div className={clsx("flex flex-col gap-6")}>
                    <NumberField
                        number={linkedinMemberCount ?? 5000}
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className={clsx("flex flex-col gap-6")}>
                    <NumberField number={12} label="X Followers" />
                </div>
            </div>
        </div>
    );
